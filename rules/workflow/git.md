...
- Tiếng Việt hoặc tiếng Anh đều được, nhưng phải rõ nghĩa. ❌ Không commit message kiểu `fix`, `update`, `wip`.
...
- Secret, connection string thật, file `.env` chứa credential → dùng `.gitignore` + biến môi trường (xem [`../coding/security.md`](../coding/security.md)).
